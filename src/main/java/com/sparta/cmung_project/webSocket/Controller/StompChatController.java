...
//        Member member = new Member();
        ...
        RoomInfoResponseDto responseDto = roomService.createRoom(inviteDto.getNickname(),parsedmemberId, inviteDto.getMemberId(), inviteDto.getPostId(), inviteDto.getTitle());/*채팅방 개설*/
